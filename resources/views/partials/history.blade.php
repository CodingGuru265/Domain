...
<body class="ubuntu-light">
    <section class="relative min-h-screen  text-white overflow-hidden py-10 px-10">
        <!-- Background elements -->
      ...
      <div class="carousel-item flex-shrink-0 w-64 mx-4">
        <div class="bg-[var(--theme-color)] bg-opacity-50 rounded-lg overflow-hidden shadow-xl h-full flex flex-col">
          ...
          <div class="p-4 flex-grow flex flex-col">
            ...
            <p class="text-sm mt-2">Established during Bingu wa Mutharika's administration.</p>
          </div>
        </div>
      </div>
